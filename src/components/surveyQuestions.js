...
export const questions = [
	...
	},
	{
		...
		options: [
			...
			{ id: 4, text: "Fourgonnettes et utilitaires transportant du matériel (artisan…)", next: "Q8" },
	...
	},
	{
		...
		text: "Motif origine",
		options: [
			{ id: 0, text: "Domicile", next: "Q11" },
			{ id: 1, text: "Travail", next: "Q11" },
			{ id: 2, text: "Affaires professionnelles", next: "Q11" },
			{ id: 3, text: "Études", next: "Q11" },
			{ id: 4, text: "Achats", next: "Q11" },
			{ id: 5, text: "Soins, démarches admin", next: "Q11" },
			{ id: 6, text: "Loisirs", next: "Q11" },
			{ id: 7, text: "Visites", next: "Q11" },
			{ id: 8, text: "Vacances, week-end, tourisme", next: "Q11" },
			{ id: 9, text: "Rabattement sur transport en commun", next: "Q11" },
			{ id: 10, text: "Accompagnement + domicile", next: "Q11" },
			{ id: 11, text: "Accompagnement + travail", next: "Q11" },
			{ id: 12, text: "Accompagnement + affaires professionnelles", next: "Q11" },
			{ id: 13, text: "Accompagnement + études", next: "Q11" },
			{ id: 14, text: "Accompagnement + achats", next: "Q11" },
			{ id: 15, text: "Accompagnement + soins, démarches admin", next: "Q11" },
			{ id: 16, text: "Accompagnement + loisirs", next: "Q11" },
			{ id: 17, text: "Accompagnement + visites", next: "Q11" },
			{ id: 18, text: "Accompagnement + vacances, week-end, tourisme", next: "Q11" },
			{ id: 19, text: "Accompagnement + rabattement sur transport en commun", next: "Q11" },
	...
	},
	{
		...
		freeText: true,
		freeTextPlaceholder: "Champs libres",
		next: "end",
	},
];